        ...
        children: [
          ...
          SafeArea(
              child: SingleChildScrollView(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                         ...
                         Row(
                            children: [
                              Icon(Icons.home,color: icon?text:c,),
                              SizedBox(width: 20,),
                              Text('Home',
                              style: GoogleFonts.aBeeZee(
                                fontSize: 17,
                          ...
                          Row(
                            children: [
                              Icon(Icons.analytics,color: icon?text:c,),
                              SizedBox(width: 20,),
                              Text('Analystics',
                              style: GoogleFonts.aBeeZee(
                                fontSize: 17,
                          ...
                          Row(
                            children: [
                              Icon(Icons.category,color: icon?text:c,),
                              SizedBox(width: 20,),
                              Text('Catgories',
                              style: GoogleFonts.aBeeZee(
                                fontSize: 17,
                      ...
                      children: [
                       ...
                       const SizedBox(height: 10,),
                        ...
                        if(state.tasks.toString()=='0')
                            Text('it is time for : استراحة محارب',
                            style: TextStyle(
                              fontSize: 16,
                              color: icon?text:c,
                            ),
                ...
                }, icon: icon?Icon(dark,color: Colors.white,):Icon(light,color: Colors.black,)
                )
                          ],
                        ),
              )
            ...
            builder: (_, double val, __) {
              return (Transform(
                transform: Matrix4.identity()
                  ..setEntry(3, 2, 0.001)
                  ..setEntry(0, 3, MediaQuery.of(context).size.height*0.36.toDouble()*val)
                  ..rotateY((pi / 6) * val),
                child: Scaffold(
...
void handlechange(ToDo todo){
  ...
  void addTask(String task){
      setState(() {
        todolist.add(ToDo(id: DateTime.now().microsecondsSinceEpoch.toString(), text: task));
      });
    controllerr.clear();
  }
}
